              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <a href="mailto:info@primexltd.com" className="text-blue-600 hover:text-blue-700">
                      info@primexltd.com
                    </a>
                    <p className="text-gray-600 text-sm mt-1">For general inquiries</p>
                    <a href="mailto:sales@primexltd.com" className="text-blue-600 hover:text-blue-700 block mt-2">
                      sales@primexltd.com
                    </a>
                    <p className="text-gray-600 text-sm mt-1">For sales inquiries</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600 text-sm mt-1">Mon-Fri 8am-6pm (Local Time)</p>
                  </div>
                </div>
