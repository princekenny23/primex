          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <a href="mailto:primexltd876@gmail.com" className="hover:text-blue-500 transition-colors duration-200">
              ...
              <li className="flex items-start">
                ...
                <span>Headquarters, Lilongwe, Malawi</span>
              </li>
            </ul>
          </div>
        </div>
