      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-2xl font-bold text-white">
                Prime<span className="text-blue-500">X</span>
              </span>
            </div>
            <p className="text-gray-400 mb-4 max-w-md">
              Integrated enterprise software solutions designed for modern businesses.
              Streamline your operations with our comprehensive ERP ecosystem.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/erp" className="hover:text-blue-500 transition-colors duration-200">
                  ERP Ecosystem
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/book-demo" className="hover:text-blue-500 transition-colors duration-200">
                  Book a Demo
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="flex items-start">
                ...
                <a href="mailto:info@primexltd.com" className="hover:text-blue-500 transition-colors duration-200">
                  info@primexltd.com
                </a>
              </li>
              <li className="flex items-start">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © {currentYear} PrimeX Ltd. All rights reserved.
          </p>
